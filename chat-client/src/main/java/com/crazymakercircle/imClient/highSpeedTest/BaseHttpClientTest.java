package com.crazymakercircle.imClient.highSpeedTest;
...
public class BaseHttpClientTest {
    ...
    protected static final int REQUEST_COUNT = 15;
    ...
    protected static final String TEST_URL = "http://sohu.com";

    protected static long averageLength = 0;
    ...
    protected synchronized void addContentLength(long len) {
        averageLength += len;
    }
